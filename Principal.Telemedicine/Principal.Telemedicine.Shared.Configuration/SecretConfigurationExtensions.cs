...
public static class SecretConfigurationExtensions
{
    ...
    /// <returns></returns>
    public static IHostBuilder UseSecretConfiguration<T>(this IHostBuilder hostBuilder, IConfiguration configuration, ILogger logger,  string secretsPath) where T : class
    {
